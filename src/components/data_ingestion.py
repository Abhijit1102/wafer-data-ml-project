...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self,collection_name, db_name):
        try:
            mongo_client = MongoClient("mongodb+srv://snshrivas:Snshrivas@cluster0.u46c4.mongodb.net/?retryWrites=true&w=majority")

            collection = mongo_client["pwskills"]["waferfault"]
